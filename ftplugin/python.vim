...
nnoremap <buffer> <leader>rpd :!autopep8 --ignore=E126,E127 --max-line-length=999 -a -a --diff % \| cdiff<CR>
nnoremap <buffer> <leader>rpa :!autopep8 --ignore=E126,E127 --max-line-length=999 -a -a -i %<CR>
